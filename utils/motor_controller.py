...
class MotorController:
    ...
    def __init__(self, name, motor_forward_pin, motor_reverse_pin, motor_pwm_pin):
    ...
    def drive_motor(self, direction='f', motor_speed = 0.5):
        ...
        self.my_motor_speed.ChangeDutyCycle(motor_speed)
